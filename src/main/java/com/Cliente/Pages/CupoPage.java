...
public class CupoPage extends CupoMap {
	...
	//Metodo que me permite verificar el numero scav en cupo
		...
		public CupoPage ScavCupo_571690(File folderPath,String Evidencia,
			...
			Assert.assertTrue(validarElemento(AlertaBusqueda, 5), "Caso exitoso 596750");
            ValidacionObjeto(validarElemento(AlertaBusqueda, 5), "Caso Exitoso 596753 ,", folderPath, Evidencia);
