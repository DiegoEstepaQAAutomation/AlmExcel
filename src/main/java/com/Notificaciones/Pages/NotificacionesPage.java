...
public class NotificacionesPage extends NotificacionesMap {
	...
	public NotificacionesPage Notificacion_557159(File folderPath,String DatoFaltante,
		...
		Assert.assertTrue(validarElemento(DaysBox, 0),"valida caja de dias/cupo, Caso exitoso 557150,557151,557152,557153,557154,557155");
        ValidacionObjeto(validarElemento(DaysBox, 0), "valida caja de dias/cupo, Caso exitoso 557150,557151,557152,557153,557154,557155", folderPath, Evidencia);
