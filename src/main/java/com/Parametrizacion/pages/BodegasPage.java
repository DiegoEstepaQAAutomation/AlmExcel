...
public class BodegasPage extends BodegaMap {
	...
	//Crear bodega 
		...
		
		{
			...
			Assert.assertTrue(validarElementoC(AlertaBusqueda, 6, Evidencia, "Mensaje de error:no se logro validar elemento"), "Caso exitoso 567519");
            ValidacionObjeto(validarElementoC(AlertaBusqueda, 6, Evidencia, "Mensaje de error:no se logro validar elemento"), Evidencia, folderPath, Evidencia);
