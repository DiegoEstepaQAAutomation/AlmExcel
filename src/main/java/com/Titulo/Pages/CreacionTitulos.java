...
public class CreacionTitulos extends ExpedirMap {
	...
	public CreacionTitulos ValidacionExpedirFormulario(File folderPath,String Empresa2, String informacionGeneralE,String Titulo,
		...
		*/
		...
		Assert.assertTrue(validarElemento(alertaLiberacion, 10), "Validacion de aplicacion caso: ");
        ValidacionObjeto(validarElemento(alertaLiberacion, 10), "Validacion de aplicacion caso: ", folderPath, Evidencia);
