 ...
 public ExpedirPage LpnDtlnumCoincidan1(File folderPath,String TipoDeBodega,String estadoA,String Mercancias,
	...
	//Escritura del titulo
     ...
     click(btnActualizarCantidades, folderPath, "click Actualizar Cantidades",Evidencia);
		...
		Assert.assertTrue(validarElemento(AlertaCargue, 10));
        ValidacionObjeto(validarElemento(AlertaCargue, 10), "Validacion", folderPath, Evidencia);
     ...
     //desplazarseVertical(0, 300);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(lblProductos, 10));
        ValidacionObjeto(validarElemento(lblProductos, 10), "Validacion de los productos", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(lblCantidadSaldo, 10));
        ValidacionObjeto(validarElemento(lblCantidadSaldo, 10), "Validacion de Cantidad Saldo", folderPath, Evidencia);
	...
	public ExpedirPage ValidacionExpedirDivisionIngresos(File folderPath, String InfGTitulo, String ingreso, 
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(alertaLiberacion, 10));
		ValidacionObjeto(validarElemento(alertaLiberacion, 10), "Validacion de la suma del porcentaje deben ser 100 caso exitoso 556554 ", folderPath, Evidencia);
   ...
   //Click en localizador por variable 
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(txtCodigoSapExp, 10));
		ValidacionObjeto(validarElemento(txtCodigoSapExp, 10), "Validacion del Codigo Sap Expedicion caso exitoso 556557 ", folderPath, Evidencia);
   ...
   //Se escribe un valor en las opciones de codigo SAP 
     ...
     //Click en localizador en este caso menu de division de ingreso
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(ImpresionBonoprenda, 10) );
		Assert.assertTrue(validarElemento(ImpresionBonoprendaB, 10) );
        ValidacionObjetos(validarElemento(ImpresionBonoprenda, 10),validarElemento(ImpresionBonoprendaB, 10), "caso exitoso 556556 se valida impresion", folderPath, Evidencia);
        //VALIDACION POR MEDIO DEL ASSERT
      	Assert.assertTrue(validarElemento(ImpresionCDM, 10) );
      	Assert.assertTrue(validarElemento(ImpresionCDMB, 10) );
        ValidacionObjetos(validarElemento(ImpresionCDM, 10),validarElemento(ImpresionCDMB, 10), "caso exitoso 556556 se valida impresion", folderPath, Evidencia);
        //VALIDACION POR MEDIO DEL ASSERT
      	Assert.assertTrue(validarElemento(ImpresionA, 10) );
      	Assert.assertTrue(validarElemento(ImpresionB, 10) );
        ValidacionObjetos(validarElemento(ImpresionA, 10),validarElemento(ImpresionB, 10), "caso exitoso 556556 se valida impresion", folderPath, Evidencia);      
	...
	public ExpedirPage ValidacionScav_571761(File folderPath,
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(btnScav, 10) );
        ValidacionObjeto(validarElemento(btnScav, 10), "Caso exitoso 571755", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertaBusqueda, 10), "Caso exitoso 571758,571762,571761");
        ValidacionObjeto(validarElemento(AlertaBusqueda, 10), "Caso exitoso 571758,571762,571761", folderPath, Evidencia);
	...
	//Paso a paso de visualizar un titulo
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(EncabezadoFicha, 10), "Caso exitoso 571764");
        ValidacionObjeto(validarElemento(EncabezadoFicha, 10), "Caso exitoso 571764", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertaBusqueda, 5) );
        ValidacionObjeto(validarElemento(AlertaBusqueda, 5), "Caso exitoso 571689,571689", folderPath, Evidencia);
		...
		
		{
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(EncabezadoFichaScavLiberaciones, 10) );
	        ValidacionObjeto(validarElemento(EncabezadoFichaScavLiberaciones, 10), "Caso exitoso 571780", folderPath, Evidencia);
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(AlertaBusqueda, 10) );
	        ValidacionObjeto(validarElemento(AlertaBusqueda, 10), "Caso exitoso 571783", folderPath, Evidencia);
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(AlertaBusqueda, 5) );
	        ValidacionObjeto(validarElemento(AlertaBusqueda, 5), "Caso exitoso 571784,571785", folderPath, Evidencia);
	...
	{ 
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(alertaLiberacion, 10));
        ValidacionObjeto(validarElemento(alertaLiberacion, 10), "Se valida que el titulo ya no tiene liberaciones del caso 543829 caso exitoso", folderPath, Evidencia);
	...
	public ExpedirPage ValidacionExpedicion_542372(File folderPath,String NitClienteAsociado,String TipoDato,String InformacionGeneral,
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(btnDescargar, 10));
		Assert.assertTrue(validarElemento(btnCargue1, 10));
        ValidacionObjetos(validarElemento(btnDescargar, 10),validarElemento(btnCargue1, 10), " Se valida la presencia de los botones de carge y descargue de archivos", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertaCargue, 10));
        ValidacionObjeto(validarElemento(AlertaCargue, 10), "caso 542371 se valida la existencia de la alerta de cargue no exitoso, no aparece una alerta de error sino de advertencia por tanto el caso 542371 falla", folderPath, Evidencia);
        
		fileUpFull(btnCargue, RouteA);

		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertaCargue, 10));
		ValidacionObjeto(validarElemento(AlertaCargue, 10), "caso 542370 es exitoso ,542373 es exitoso,542375 se valida la existencia de la alerta de cargue exitoso, 542375 cargue de datos decimales esta prueba falla porque si permitio realizar la carga de archivos, Caso 542378 exitoso se carga esa cantidad de mercancias", folderPath, Evidencia);
		        
		fileUpFull(btnCargue, RouteB);
		
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertaCargue, 10));
		ValidacionObjeto(validarElemento(AlertaCargue, 10), "casos exitosos 542370,542373,542376, se valida la existencia de la alerta de cargue exitoso,caso 542376 falla porque no esta la tabla de calculo, valida cargue de caso 542377", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertaCargue, 10));
		ValidacionObjeto(validarElemento(AlertaCargue, 10), "caso 542492 exitoso se valida el mensaje de cargue exitoso de un archivo con cantidades negativas", folderPath, Evidencia);
	...
	public ExpedirPage ValidacionHistorico_546943(File folderPath,
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(lblVisualizarHistorico, 10));
		ValidacionObjeto(validarElemento(lblVisualizarHistorico, 10), "caso 546943,546947 se valida existencia de boton visualizar ", folderPath, Evidencia);
	...
	public ExpedirPage UsuarioAdmin(File folderPath,String etiquetaPoliza,String  poliza, 
		...
		Assert.assertTrue(validarElemento(btnCargue1, 10));
		click(locatorVariable(lblOpciones, Mercancias), folderPath, "Click en Mercancias",Evidencia);
		ValidacionObjetos(validarElemento(btnDescargar, 10),validarElemento(btnCargue1, 10), "542493 Se valida la presencia de los botones de carge y descargue de archivos", folderPath, Evidencia);
	...
	public ExpedirPage UsuarioEditarAdmin_545511(File folderPath,String usuario2,String ModuloT,String SubModuloExpedir,
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(btnVisualizarImpresiones, 10));
		ValidacionObjeto(validarElemento(btnVisualizarImpresiones, 10), "Caso 545514 se valida boton impresiones", folderPath, Evidencia);
		...
		Assert.assertTrue(validarElemento(ImpresionA, 10));
		Assert.assertTrue(validarElemento(ImpresionCDM, 10));
		ValidacionObjetos(validarElemento(ImpresionA, 10),validarElemento(ImpresionCDM, 10), "caso exitoso 545515, 545516, 545517 se valida impresion", folderPath, Evidencia);
				 
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(ImpresionBonoprenda, 10));
		ValidacionObjeto(validarElemento(ImpresionBonoprenda, 10), "caso exitoso 545515, 545516, 545517 se valida impresion", folderPath, Evidencia);
	...
	public ExpedirPage UsuarioAplicador_554763(File folderPath,String usuario2,String ModuloT,String SubModuloExpedir,String titulograbado,
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(alertaLiberacion, 10));
		ValidacionObjeto(validarElemento(alertaLiberacion, 10), "Validacion de aplicacion caso 554751 ,554763 ", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(alertaLiberacion, 10));
		ValidacionObjeto(validarElemento(alertaLiberacion, 10), "Validacion de creacion de titulo 554749", folderPath, Evidencia);
			...
			String estadoA,String infogeneraltitulo,String Evidencia) throws Exception
	{
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(alertaLiberacion, 10));
		ValidacionObjeto(validarElemento(alertaLiberacion, 10), "Validacion de aplicacion caso exitoso 558601 ,558595, ", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(BodegaOpcionTransito, 10));
		ValidacionObjeto(validarElemento(BodegaOpcionTransito, 10), "Validacion de aplicacion caso 558599 ,554763,558600,558602,558609 ", folderPath, Evidencia);
	...
	public ExpedirPage OperacionTitulo_552036(File folderPath, 
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(TipoOperacion, 10));
			ValidacionObjeto(validarElemento(TipoOperacion, 10), "Se valida boton de tipo de operacion", folderPath, Evidencia);
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(TipoOperacion, 10));
			ValidacionObjeto(validarElemento(TipoOperacion, 10), "Se valida boton de tipo de operacion caso 552036,552037,552038", folderPath, Evidencia);
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(btnAlertaTipoOperacion, 10));
			ValidacionObjeto(validarElemento(btnAlertaTipoOperacion, 10), "Se valida boton de tipo de operacion", folderPath, Evidencia);
			...
			//VALIDACION POR MEDIO DEL ASSERT
			Assert.assertTrue(validarElemento(AlertChangesSaved, 10));
			ValidacionObjeto(validarElemento(AlertChangesSaved, 10), "Se valida alerta de cambios realizados, caso exitoso 552036,552037,552038,552039,552040", folderPath, Evidencia);
			...
			throws Exception 
	{
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(CampoModificarLiberacion, 10));
		ValidacionObjeto(validarElemento(CampoModificarLiberacion, 10), "caso 548142", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(AlertChangesSaved, 10));
		ValidacionObjeto(validarElemento(AlertChangesSaved, 10), "caso  exitoso 548142,548143,548144 cambios realizados", folderPath, Evidencia);
		...
		//VALIDACION POR MEDIO DEL ASSERT
		Assert.assertTrue(validarElemento(btnVisualizarAutorizacionPendiente, 10));
		ValidacionObjeto(validarElemento(btnVisualizarAutorizacionPendiente, 10), "caso 548144", folderPath, Evidencia);
