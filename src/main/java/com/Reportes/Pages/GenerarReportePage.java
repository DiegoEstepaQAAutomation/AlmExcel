...
public class GenerarReportePage extends GenerarReporteMap {
	...
	
	{
		...
		Assert.assertTrue(validarElemento(AlertaExitoso, 10), "casos exitosos");
        ValidacionObjeto(validarElemento(AlertaExitoso, 10), "casos exitosos", folderPath, Evidencia);
